    ...
    <div className="hidden lg:block fixed top-0 left-0 bottom-0 z-50">
      <div className="h-full w-60 bg-white dark:bg-gray-800 border-r border-gray-300 dark:border-gray-700 flex flex-col">
        <div className="flex items-center p-6">
          <h1 className="text-2xl font-bold text-blue-400 dark:text-blue-400">Meme Vault</h1>
        </div>
          ...
          <div className="space-y-1 px-3">
            {[
              ...
              { 
                icon: Bell, 
                label: "Notifications", 
                path: `/notifications/${loggedInUserName || user.username}`,
              ...
              <button
                ...
                `}
              >
                <item.icon className={`w-6 h-6 mr-3 transition-all duration-200 sidebar-icon
        ...
        <div className="border-t border-gray-100 dark:border-gray-700 p-4">
          <button 
            onClick={() => handleNavigation(`/profile/${loggedInUserName || user.username || ""}`)}
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <p className="font-medium text-black dark:text-white text-sm truncate">{loggedInUserName || user.username}</p>
