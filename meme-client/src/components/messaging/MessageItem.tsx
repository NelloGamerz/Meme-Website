...
//   return (
//     <div className={`flex items-start gap-3 p-2 sm:p-3 group relative ${
...
//           <img
//             src={message.senderProfilePicture || "https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=150&h=150&fit=crop&crop=face"}
...
//           ) : (
//             /* Display Mode */
//             <div className={`relative max-w-[85%] sm:max-w-md lg:max-w-lg xl:max-w-xl rounded-2xl px-4 py-2 shadow-sm ${
//               isOwnMessage
//                 ? 'bg-gradient-to-br from-blue-500 to-indigo-500 text-white rounded-tr-sm'
//                 : 'bg-gray-50 border border-gray-200 dark:bg-gray-800 dark:border-gray-700 text-gray-900 dark:text-white rounded-tl-sm'
...
//               {/* Footer: time + status */}
//               {showFooterTime && (
//                 <div className={`mt-1 flex items-center ${isOwnMessage ? 'justify-end' : 'justify-start'} gap-2 opacity-80`}>
//                   <span className="text-[10px] sm:text-xs">
//                     {formatTimestamp(message.timestamp)}
//                   </span>
//                   {isOwnMessage && (
//                     <span className={`text-[10px] sm:text-xs ${message.read ? 'opacity-100' : 'opacity-60'}`}>✓✓</span>
//                   )}
//                 </div>
//               )}
//             </div>
...
//             <div className={`absolute ${isOwnMessage ? '-top-2 -left-2' : '-top-2 -right-2'} opacity-0 group-hover:opacity-100 transition-opacity`}>
...
//                 {showMenu && (
//                   <div className={`absolute ${isOwnMessage ? 'left-0' : 'right-0'} mt-1 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-lg shadow-lg z-10 min-w-[120px]`}>
//                     <button
//                       onClick={handleEdit}
